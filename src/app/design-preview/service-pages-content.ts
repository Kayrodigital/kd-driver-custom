...
export const servicePages: ServicePageContent[] = [
  {
    ...
    lead: "Votre chauffeur suit votre vol et vous attend, quelle que soit l’heure d’arrivée.",
    ...
    presentationBody: "Que vous atterrissiez tôt le matin ou tard le soir, votre chauffeur ajuste la prise en charge à l’heure réelle de votre vol et vous accompagne jusqu’à votre destination à Lyon ou dans sa région.",
    benefits: [
  ...
  },
  {
    ...
    lead: "Prise en charge à Part-Dieu ou Perrache, ajustée à l’horaire réel de votre train.",
    ctaLabel: "Réserver mon transfert",
    heroImage: "/images/service-transferts.jpg",
    presentationEyebrow: "La prestation",
    presentationTitle: "Un départ ou une arrivée sans course contre la montre",
    presentationBody: "Votre chauffeur vous attend directement à la gare, ou vient vous chercher avec la marge nécessaire pour ne jamais manquer votre train.",
    benefits: [
